...
class _MyPageContentState extends State<MyPageContent> {
  ...
  List<GatherList> myUploadTest = [];
  List<GatherList> myPartiTest = [];
...
Widget CustomListTile(List<GatherList> testList, int index) {
  return Column(
    children: [
      ListTile(
        leading: ClipOval(
